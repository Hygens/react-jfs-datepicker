        ...
        function s(o, u) {
            ...
            (function (global) {
                ...
                exports['default'] = _react2['default'].createFactory({
                    ...
                    render: function render() {
                        return _react2['default'].createElement('div', { className: "datePicker", onClick: this.onClickDatePickerArea }, _react2['default'].createElement('input', { className: 'datePicker__input ' + (this.props.disabled === true ? 'datePicker__input--disabled' : ''), type: 'text', onFocus: this.focusIn, value: this.props.value, readOnly: true, disabled: this.props.disabled }), this.state.isCalendarShow === false ? null : this.calender());
                    }
                });
            ...
            (function (global) {
                ...
                exports['default'] = _react2['default'].createFactory({
                    ...
                    render: function render() {
                        return _react2['default'].createElement('div', { className: "datePicker__calendar" }, _react2['default'].createElement('div', { className: "datePicker__calendar__header" }, _react2['default'].createElement('span', { onClick: this.prevMonth, className: "datePicker__prev" }), _react2['default'].createElement(_selectYear2['default'], { year: Number(this.state.year), selectYear: this.selectYear, range: this.props.range }), _react2['default'].createElement(_selectMonth2['default'], { month: Number(this.state.month), selectMonth: this.selectMonth, locale: this.props.locale }), _react2['default'].createElement('span', { onClick: this.nextMonth, className: "datePicker__next" })), _react2['default'].createElement(_weekDays2['default'], { locale: this.props.locale, highlight: new Date(this.props.date).getFullYear() === this.state.year && new Date(this.props.date).getMonth() + 1 === this.state.month, year: Number(this.state.year), month: Number(this.state.month), day: Number(this.state.day), selectDay: this.selectDay }), _react2['default'].createElement('div', { className: "datePicker__btnGroup" }, _react2['default'].createElement('button', { className: "datePicker__btn datePicker__btn--today", onClick: this.props.selectToday }, this.props.locale === 'zh' ? '今天' : 'Today')));
                    }
                ...
                exports['default'] = _react2['default'].createFactory({
                    ...
                    render: function render() {
                        ...
                        var options = months.map(function (month, index) {
                            return _react2['default'].createElement('option', { key: index, value: index + 1 }, '' + month);
                        });
                        return _react2['default'].createElement('select', { value: this.props.month, className: "datePicker__month", onChange: this.handleChange }, options);
                    }
                });
                module.exports = exports['default'];
            }).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
                ...
                exports['default'] = _react2['default'].createFactory({
                    ...
                    render: function render() {
                        ...
                        options = options.map(function (option) {
                            return _react2['default'].createElement('option', { key: option, value: option }, option);
                        });
                        return _react2['default'].createElement('select', { value: this.props.year, className: "datePicker__year", onChange: this.handleChange }, options);
                    }
                });
                module.exports = exports['default'];
            }).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
            ...
            (function (global) {
                ...
                exports['default'] = _react2['default'].createFactory({
                    ...
                    render: function render() {
                        var days = (typeof this.props.days === 'undefined' ? [] : this.props.days).map(function (day, index) {
                            if (day) {
                                ...
                                if (day === this.props.day && this.props.highlight) {
                                    return _react2['default'].createElement('td', { key: index, className: 'datePicker__day--today datePicker__day', onClick: this.handleClick }, day);
                                } else {
                                    return _react2['default'].createElement('td', { key: index, className: "datePicker__day", onClick: this.handleClick }, day);
                                }
                            } else {
                        ...
                        return _react2['default'].createElement('tr', null, days);
                    }
                });
                module.exports = exports['default'];
            }).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
                    ...
                    render: function render() {
                        ...
                        if (this.props.locale === 'zh') {
                            weekTitle = ['日', '一', '二', '三', '四', '五', '六'].map(function (v) {
                                return _react2['default'].createElement('th', { key: v }, v);
                            });
                        } else {
                        ...
                        return _react2['default'].createElement('table', null, _react2['default'].createElement('thead', null, _react2['default'].createElement('tr', null, weekTitle)), _react2['default'].createElement('tbody', null, weekDays));
                    }
                });
                module.exports = exports['default'];
            }).call(this, typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
